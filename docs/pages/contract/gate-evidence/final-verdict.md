...
- Frozen oracle coverage is present; final report records 415/415 passed.
...
- Legacy decoder tolerance is explicitly documented compatibility behavior, not an untracked exception.
