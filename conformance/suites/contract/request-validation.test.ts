...
const negativeCases: NegativeCase[] = [
  ...
  { id: "CONTRACT-VALIDATION-CHARACTER-CONTACT-ADD-EMPTY-001", target: "character", path: "characters/{id}/ops/contact.add", body: { name: "" }, note: "contact.add with empty name (minLength 1)" },
  { id: "CONTRACT-VALIDATION-CHARACTER-CONTACT-CLOSENESS-ENUM-001", target: "character", path: "characters/{id}/ops/contact.closeness", body: { name: "x", closeness: "best-friend" }, note: "contact.closeness with out-of-enum closeness" },
  { id: "CONTRACT-VALIDATION-CHARACTER-CONTACT-ADD-EXTRA-FIELD-001", target: "character", path: "characters/{id}/ops/contact.add", body: { name: "x", entry: "y" }, note: "character contact.add with a rolodex-era field (additionalProperties:false)" },
